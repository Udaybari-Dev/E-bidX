    ...
    <>
      <div className="lg:h-[85vh] py-20 p-5 lg:px-12 flex items-center justify-center flex-wrap lg:flex-nowrap gap-5 text-white">
        <div className="block overflow-hidden">
          <div className="w-[300px] h-[300px] bg-[#ffba00] rounded-full blur-[150px] absolute left-[-50px] top-[-80px]"></div>
          <div className="w-[200px] h-[200px] bg-[#ffba00] rounded-full blur-[150px] absolute left-[45%] top-[100px]"></div>
          <div className="w-[250px] h-[250px] bg-[#ffba00] rounded-full blur-[150px] absolute  right-[50px] bottom-[80%] lg:bottom-[70%]"></div>
        </div>
